...
import (
	...
	model "github.com/liangjunmo/goproject/internal/goproject/model"
	mock "github.com/stretchr/testify/mock"

	pagination "github.com/liangjunmo/goproject/internal/pkg/pagination"

	repository "github.com/liangjunmo/goproject/internal/goproject/repository"
)
...
func (_m *MockUserRepository) List(ctx context.Context, criteria repository.UserCriteria) (pagination.Pagination, []model.User, error) {
	...
	var r1 []model.User
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, repository.UserCriteria) (pagination.Pagination, []model.User, error)); ok {
		return rf(ctx, criteria)
	}
	if rf, ok := ret.Get(0).(func(context.Context, repository.UserCriteria) pagination.Pagination); ok {
		r0 = rf(ctx, criteria)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, repository.UserCriteria) []model.User); ok {
		r1 = rf(ctx, criteria)
	} else {
		if ret.Get(1) != nil {
	...
	if rf, ok := ret.Get(2).(func(context.Context, repository.UserCriteria) error); ok {
		r2 = rf(ctx, criteria)
	} else {
		r2 = ret.Error(2)
	}
...
func (_e *MockUserRepository_Expecter) List(ctx interface{}, criteria interface{}) *MockUserRepository_List_Call {
	return &MockUserRepository_List_Call{Call: _e.mock.On("List", ctx, criteria)}
}

func (_c *MockUserRepository_List_Call) Run(run func(ctx context.Context, criteria repository.UserCriteria)) *MockUserRepository_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockUserRepository_List_Call) Return(_a0 pagination.Pagination, _a1 []model.User, _a2 error) *MockUserRepository_List_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MockUserRepository_List_Call) RunAndReturn(run func(context.Context, repository.UserCriteria) (pagination.Pagination, []model.User, error)) *MockUserRepository_List_Call {
	_c.Call.Return(run)
	return _c
}
